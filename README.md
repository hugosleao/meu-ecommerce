...
Este é o repositório onde reside todo o código da aplicação `meu-ecommerce`.
...
- **Postgres:** Banco de dados relacional da aplicação `meu-ecommerce`.
...
Acesse a aplicação em: [https://meuecommerce.internal:44300](https://meuecommerce.internal:44300)
...
- [Frontend](https://meuecommerce.internal:44300)
- [Main API](https://meuecommerce.internal:44300/main/swagger)
- [Order API](https://meuecommerce.internal:44300/order/swagger)
- [Identity API](https://meuecommerce.internal:44300/identity/swagger)
- [Health Checks API](https://meuecommerce.internal:44300/healthchecks/ui)
- [Invoice Worker API](https://meuecommerce.internal:44300/invoice/swagger)
- [Notificator Worker API](https://meuecommerce.internal:44300/notificator/swagger)
